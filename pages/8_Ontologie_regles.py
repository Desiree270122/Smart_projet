...
def trouver_fichier_ontologie():
    ...
    chemins_possibles = [
        ...
        # Chemin absolu local utilisé pendant le développement.
...
if st.button(
    "Consulter le fonctionnement en temps réel et l’exportation",
    type="primary",
):
    st.switch_page("pages/9_Temps_reel_export.py")
